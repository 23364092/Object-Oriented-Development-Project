...
public class PayrollSystemMenu {
    ...
    /**
     * Runs the Payroll System Menu, presenting options for Employees,
     * Human Resources, and Admin users to interact with the system.
     *
     * @param payroll The PayrollSystem instance to perform operations on.
    ...
    /**
     * Handles the Admin menu, providing options such as viewing payslips,
     * adding employees, and accessing employee details.
     *
     * @param payroll The PayrollSystem instance to interact with.
     */
            if (command.equals("A")) {
    ...
    /**
     * Handles Employee menu operations, allowing employees to view payslips,
     * details, and promotion offers.
     *
     * @param payroll The PayrollSystem instance to interact with.
     */
    ...
    /**
     * Handles Human Resources (HR) menu operations, providing options
     * for managing promotions and accessing employee records.
     *
     * @param payroll The PayrollSystem instance to interact with.
     */
    ...
    /**
     * Handles adding a new employee to the payroll system.
     *
     * @param payroll The PayrollSystem instance to update.
     */
                                    if (command.equals("Y")) {
